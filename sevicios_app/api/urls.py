...
urlpatterns = [
    ...
    path('descargar_inventario_categoria/<str:date>', getDownloadInventoryAvailableCategory, name='getDownloadInventoryAvailableCategory'),
    path('lista_tiendas/', getListTiendas, name='getListTiendas'),  
    path('redireccion/<str:pedido>/<str:shop>', patchRedireccion, name='patchRedireccion'),      
    path('bugs_relevantes/', getBusRelevant, name='getBusRelevant'),    
    path('descargar_inventario_disponible_muebles/', getDownloadInventoryAvailableFurniture, name='getDownloadInventoryAvailableFurniture'),  
    path('contenedor-pieza/<str:pedido>', getContainerPza, name='getContainerPza'),   
    path('compras-semanales/', getComprasSemanales, name='getComprasSemanales'),     
    path('descargar_inventario_disponible_cl/<str:date>', getDownloadInventoryAvailableCL, name='getDownloadInventoryAvailableCL'),
    path('inventario_disponible_cl/<str:date>', getInventoryAvailableCL, name='getInventoryAvailableCL'),
]